...
public class OrikiOroAropoAfarajerukoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oro_aropo_afarajoruko_definition);


        RelativeLayout layout = findViewById(R.id.oro_aropo_afarajoruko_definition);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    playmusic = MediaPlayer.create(getApplicationContext(), R.raw.afarajoruko_je_oro);
