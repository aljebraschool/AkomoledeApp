...
public class OroOrukoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //word.add("one")
        Word w = new Word(R.string.oriki_oro_oruko, R.string.definition, R.drawable.baseline_arrow_forward_ios_white_48);
        words.add(w);

        //repeating the process for the remaining numbers
        words.add(new Word(R.string.apeere_oro_oruko, R.string.example_noun, R.drawable.baseline_arrow_forward_ios_white_48));
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        intent = new Intent(getApplicationContext(), OrikiOroOrukoActivity.class);
                        startActivity(intent);
                        break;

                    case 1:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), ApeereOroOrukoActivity.class);
                        startActivity(intent);
                        break;

                    case 2:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), IseIfikoraOroOrukoActivity.class);
                        startActivity(intent);
                        break;
