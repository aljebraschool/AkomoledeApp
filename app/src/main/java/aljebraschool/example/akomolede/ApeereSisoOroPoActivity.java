...
public class ApeereSisoOroPoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apeere_siso_oro);

        //creating ads
        mAdView = findViewById(R.id.apeere_siso_oro_adView_banner);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        //store the audio files i want to use in an integer array
        int[] audioFiles = {R.raw.ade_fkf, R.raw.omi_fkf, R.raw.bola_kf, R.raw.tunde_kfkf, R.raw.adeola_fkffkf, R.raw.koko_kfkf};
