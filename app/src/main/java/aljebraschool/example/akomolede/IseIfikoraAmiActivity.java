...
public class IseIfikoraAmiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ise_ifikora_ami);

        //store the audio files i want to use in an integer array
        int[] audioFiles = {R.raw.ko_awon_oro_wonyi, R.raw.mmm, R.raw.dd, R.raw.rrr, R.raw.ddm,};


        //find the layouts you wants to set events on
        TextView layout = findViewById(R.id.layout_alaye_ise_ifikora);
        LinearLayout layout1 = findViewById(R.id.layout_ise_ifikora_one);
        LinearLayout layout2 = findViewById(R.id.layout_ise_ifikora_two);
        LinearLayout layout3 = findViewById(R.id.layout_ise_ifikora_three);
        LinearLayout layout4 = findViewById(R.id.layout_ise_ifikora_four);
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (clickedLayoutId) {
                    case R.id.layout_alaye_ise_ifikora:
                        playAudioFile(audioFiles[0]);
                        break;
                    case R.id.layout_ise_ifikora_one:
                        playAudioFile(audioFiles[1]);
                        break;
                    case R.id.layout_ise_ifikora_two:
                        playAudioFile(audioFiles[2]);
                        break;

                    case R.id.layout_ise_ifikora_three:
                        playAudioFile(audioFiles[3]);
                        break;

                    case R.id.layout_ise_ifikora_four:
