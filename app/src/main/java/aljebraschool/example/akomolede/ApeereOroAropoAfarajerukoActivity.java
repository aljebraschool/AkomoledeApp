...
public class ApeereOroAropoAfarajerukoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apeere_oro_aropo_afarajoruko);

        //store the audio files i want to use in an integer array
        int[] audioFiles = {R.raw.apeere_oro_aropo_afarajoruko, R.raw.emi_ni_mo, R.raw.iwo_ni_o_ni, R.raw.awon_niyen, };


        //find the layouts you wants to set events on
        TextView layout1 = findViewById(R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_ninu_gbolohun);
        LinearLayout layout2 = findViewById(R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_1);
        LinearLayout layout3 = findViewById(R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_2);
        LinearLayout layout4 = findViewById(R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_3);
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (clickedLayoutId){
                    case R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_ninu_gbolohun:
                        playAudioFile(audioFiles[0]);
                        break;
                    case R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_1:
                        playAudioFile(audioFiles[1]);
                        break;
                    case R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_2:
                        playAudioFile(audioFiles[2]);
                        break;

                    case R.id.apeere_lilo_oro_aropo_oruko_afarajoruko_3:
