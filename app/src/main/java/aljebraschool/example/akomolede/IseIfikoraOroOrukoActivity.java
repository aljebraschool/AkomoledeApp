...
public class IseIfikoraOroOrukoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ise_ifikora_oro_oruko);


        RelativeLayout layout = findViewById(R.id.ise_ifikora_oro_oruko);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    playmusic = MediaPlayer.create(getApplicationContext(), R.raw.wo_ayika_re);
