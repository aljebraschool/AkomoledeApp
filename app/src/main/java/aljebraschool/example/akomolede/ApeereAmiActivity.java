/* The activity implements the content covered under "examples of tonal signs in yoruba" */
...
public class ApeereAmiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apeere_ami);

        //creating ads
        mAdView =  findViewById(R.id.apeere_ami_adView_banner);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);


        //store the audio files i want to use in an integer array
        int[] audioFiles = {R.raw.ade, R.raw.oba, R.raw.ijoko,R.raw.ile_redo, R.raw.bola};
