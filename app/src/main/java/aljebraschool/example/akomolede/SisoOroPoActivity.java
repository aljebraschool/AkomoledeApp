...
public class SisoOroPoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //word.add("one")
        Word w = new Word(R.string.oriki_siso_oro, R.string.definition, R.drawable.baseline_arrow_forward_ios_white_48);
        words.add(w);

        //repeating the process for the remaining numbers
        words.add(new Word(R.string.apeere_siso_oro, R.string.example_siso_oro, R.drawable.baseline_arrow_forward_ios_white_48));
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        intent = new Intent(getApplicationContext(), OrikiSisoOroPoActivity.class);
                    ...
                    case 1:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), ApeereSisoOroPoActivity.class);
                        startActivity(intent);
                        break;

                    case 2:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), IseIfikoraSisoOroPoActivity.class);
                        startActivity(intent);
                        break;
