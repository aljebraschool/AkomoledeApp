...
public class OrikiSisoOroPoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oro_siso_definition);


        RelativeLayout layout = findViewById(R.id.oro_siso_definition);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    playmusic = MediaPlayer.create(getApplicationContext(), R.raw.siso_oro_po);
