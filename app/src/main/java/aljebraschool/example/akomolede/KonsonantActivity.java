...
public class KonsonantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //creating ads
        mAdView =  findViewById(R.id.word_grid_adView_banner);
        ...
        //word.add("one")
        Word w = new Word(R.string.B, R.string.sound_b, R.raw.b, R.drawable.baseline_play_arrow_white_48);
        words.add(w);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    playmusic = MediaPlayer.create(KonsonantActivity.this, word.getAudioFile());
