...
public class OroAtiItumoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //word.add("one")
        Word w = new Word(R.string.oro_ati_itumo, R.string.words_and_meanings, R.drawable.baseline_arrow_forward_ios_white_48);
        words.add(w);

        //repeating the process for the remaining numbers
        words.add(new Word(R.string.gbolohun_kukuru, R.string.small_sentence, R.drawable.baseline_arrow_forward_ios_white_48));
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        intent = new Intent(getApplicationContext(), ItumoOroActivity.class);
                        startActivity(intent);
                        break;

                    case 1:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), GbolohunKukuruAtiItumoActivity.class);
                        startActivity(intent);
                        break;

                    case 2:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), IseIfikoraAtumoOroActivity.class);
                        startActivity(intent);
                        break;
