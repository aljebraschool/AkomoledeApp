...
public class IkiniActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //word.add("one")
        Word w = new Word(R.string.oriki_ikini, R.string.definition, R.drawable.baseline_arrow_forward_ios_white_48);
        words.add(w);

        //repeating the process for the remaining numbers
        words.add(new Word(R.string.asiko_ikini, R.string.time_of_greetings, R.drawable.baseline_arrow_forward_ios_white_48));
        words.add(new Word(R.string.akiyesi_lori_ikini, R.string.notice_on_greetings, R.drawable.baseline_arrow_forward_ios_white_48));
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (position) {
                    ...
                    case 0:
                        ...
                        intent = new Intent(getApplicationContext(), OrikiIkiniActivity.class);
                        startActivity(intent);
                        break;

                    case 1:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), AsikoAtiIkiniActivity.class);
                        startActivity(intent);
                        break;

                    case 2:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), AkiyesiLoriIkiniActivity.class);
                        startActivity(intent);
                        break;

                    case 3:
                        //explicitly creating an intent to call another activity
                        intent = new Intent(getApplicationContext(), IseIfikoraIkiniActivity.class);
                        startActivity(intent);
                        break;
