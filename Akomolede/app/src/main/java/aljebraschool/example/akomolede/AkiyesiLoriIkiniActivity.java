/* The activity implements the content covered under "akiyesi lori ikini" */
...
public class AkiyesiLoriIkiniActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.akiyesi_lori_ikini);

        //store the audio files i want to use in an integer array
        int[] audioFiles = {R.raw.ekaro_fun_agbalagba, R.raw.kaaro_fun_omode};


        //find the layouts you wants to set events on
        TextView layout = findViewById(R.id.akiyesi_ikini_textview_2);
        TextView layout2 = findViewById(R.id.akiyesi_ikini_textview_3);
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (clickedLayoutId) {
                    case R.id.akiyesi_ikini_textview_2:
                        playAudioFile(audioFiles[0]);
                        break;
                    case R.id.akiyesi_ikini_textview_3:
