...
public class IseIfikoraOroAropoAfarajorukoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ise_ifikora_oro_aropo_arafajoruko);


        RelativeLayout layout = findViewById(R.id.ise_ifikora_oro_aropo_afarajoruko);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    playmusic = MediaPlayer.create(getApplicationContext(), R.raw.toka_si_oro_aropo);
