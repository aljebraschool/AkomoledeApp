...
public class IseIfikoraOroIseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ise_ifikora_oro_ise);


        RelativeLayout layout = findViewById(R.id.ise_ifikora_oro_ise);
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    playmusic = MediaPlayer.create(getApplicationContext(), R.raw.bi_o_se_u_no_ajosepo);
